!(function (e) {
  ...
  function s(t, a) {
    t.each(function () {
      e(this).on("click", function (t) {
        ...
        var i = e(this);
        i.hasClass("active")
          ? i.removeClass("active").next(a).removeClass("show").slideUp()
  ...
  e(window).on("scroll", function () {
    ...
    e("#slider-range").slider({
      ...
      values: [60, 570],
      slide: function (t, a) {
        e("#minAmount").text("$" + a.values[0]),
          e("#maxAmount").text("$" + a.values[1]);
      },
    }),
        ...
        var o = setInterval(function () {
          ...
          s < 10 && (s = "0" + s),
            ...
            i < 0
              ...
              : (n(".day .number").html(s + " "),
                n(".hour .number").html(r + " "),
                n(".minute .number").html(l + " "),
                n(".second .number").html(c + " "));
        }, 1e3);
      });
    }),
    e(".flash-counter").length && e(".flash-counter").countdown(),
    e(".deal-counter").length && e(".deal-counter").countdown(),
    e(".offer-counter").length && e(".offer-counter").countdown(),
    (e.fn.boxNav = function (t, a, i) {
      var n = e(this),
        o = e(t),
        r = n.find(a);
      e(window).width() < 1199.99 && (s(o, n), s(r, i));
    }),
    e(".vs-box-nav").length > 0 &&
      e(".vs-box-nav").boxNav(
        ".box-nav-btn",
  ...
  (e.fn.vsTab = function (t) {
    ...
    e(this).each(function () {
      ...
      if (
        (i.on("click", function (t) {
          ...
          i.addClass("active").siblings().removeClass("active"),
            a.sliderTab ? e(o).slick("slickGoTo", i.data("slide-go-to")) : r();
        }),
        a.sliderTab)
      ) {
        ...
        i.each(function () {
          var i = e(this);
          i.attr("data-slide-go-to", s),
            s++,
            i.hasClass("active") &&
              e(o).slick("slickGoTo", i.data("slide-go-to")),
            e(o).on("beforeChange", function (e, i, n, o) {
              t
      ...
      function r() {
        ...
        n.get(0).style.setProperty("--height-set", s),
          ...
          e(i).first().position().left == o.position().left
            ? n.addClass("start").removeClass("center").removeClass("end")
            : e(i).last().position().left == o.position().left
    ...
    e(".testi-slideTab").length &&
      e(".testi-slideTab").vsTab({sliderTab: !0, tabButton: ".tab-btn"}),
    e(".vs-slideTab").length &&
      e(".vs-slideTab").vsTab({sliderTab: !0, tabButton: ".tab-btn"}),
    (e.fn.shapeMockup = function () {
      e(this).each(function () {
        var t = e(this),
          ...
          n = t.data("bottom"),
          o = t.data("left");
        t.css({top: a, right: i, bottom: n, left: o})
          .removeAttr("data-top")
    ...
    e('[data-bs-toggle="tab"], [data-bs-toggle="pill"]').on(
      "shown.bs.tab",
      function (t) {
